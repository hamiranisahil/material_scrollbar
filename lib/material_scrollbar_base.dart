...
///
/// You must call [dispose] on this [MaterialScrollBarPainter] when it's no longer used.
///
/// See also:
///
...
class MaterialScrollBarPainter extends ChangeNotifier implements CustomPainter {
  ...
  @override
  bool shouldRepaint(MaterialScrollBarPainter oldDelegate) {
...
/// [CustomScrollView], wrap the scroll view widget in a [MaterialRawScrollbar] widget.
///
...
///
/// If the child [ScrollView] is infinitely long, the [MaterialRawScrollbar] will not be
...
///
/// {@tool dartpad}
/// This sample shows a [MaterialRawScrollbar] that executes a fade animation as
...
/// `controller` for both the [MaterialRawScrollbar] and the [GridView].
...
class MaterialRawScrollbar extends StatefulWidget {
  ...
  /// See also:
  ///
  ///   * [MaterialRawScrollbarState.showScrollbar], an overridable getter which uses
  ...
  /// thumb in a [MaterialRawScrollbar].
  ///
  ...
  /// See also:
  ///
  ///   * [MaterialRawScrollbarState.enableGestures], an overridable getter which uses
  ///     this value to override the default behavior.
  /// {@endtemplate}
  ...
  @override
  MaterialRawScrollbarState<MaterialRawScrollbar> createState() => MaterialRawScrollbarState<MaterialRawScrollbar>();
}

/// The state for a [MaterialRawScrollbar] widget, also shared by the [Scrollbar] and
...
/// scrollbar track.
class MaterialRawScrollbarState<T extends MaterialRawScrollbar> extends State<T> with TickerProviderStateMixin<T> {
  ...
  /// theme.
  ///
  /// Defaults to false when [MaterialRawScrollbar.isAlwaysShown] or
  /// [MaterialRawScrollbar.thumbVisibility] is null.
  ///
  /// See also:
  ///
  ///   * [MaterialRawScrollbar.isAlwaysShown], which overrides the default behavior.
  @protected
  ...
  /// theme.
  ///
  /// Defaults to true when [MaterialRawScrollbar.interactive] is null.
  ///
  /// See also:
  ///
  ///   * [MaterialRawScrollbar.interactive], which overrides the default behavior.
  @protected
  ...
  void initState() {
    ...
    scrollbarPainter = MaterialScrollBarPainter(
      ...
      userThumbSize: widget.userThumbSize,
    );
  }
  ...
  /// [MaterialRawScrollbar].
  ///
  /// Excludes the [MaterialRawScrollbar] thumb.
  @protected
...
class _ThumbPressGestureRecognizer extends LongPressGestureRecognizer {
  ...
  bool _hitTestInteractive(GlobalKey customPaintKey, Offset offset, PointerDeviceKind kind) {
    ...
    final MaterialScrollBarPainter painter = customPaint.foregroundPainter! as MaterialScrollBarPainter;
